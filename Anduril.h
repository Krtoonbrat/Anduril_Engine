...
public:
    ...
    uint64_t zobrist(thc::ChessRules &board);
...
private:
    ...
    // hashes the board state
    uint64_t hashBoard(thc::ChessRules &board);

    // hashes castling rights
    ...
    const uint64_t zobristArray[781] = {0x9D39247E33776D41, 0x2AF7398005AAA5C7, 0x44DB015024623547, 0x9C15F73E62A76AE2,

...
Interfaces
*/
EXTERNC void _CDECL nnue_init(const char* evalFile)
{
...
EXTERNC int _CDECL nnue_evaluate(
...
EXTERNC int _CDECL nnue_evaluate_incremental(
...
EXTERNC int _CDECL nnue_evaluate_fen(const char* fen)
{
